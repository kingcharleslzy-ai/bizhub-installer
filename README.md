...
| Proposed public desktop shell and Generic local boundary | [Desktop v0.1 boundary decision](docs/desktop-v01-boundary.md) |
| Desktop cloud shell and macOS Generic local candidate | [Desktop implementation](desktop/README.md), [D1 evidence](docs/verification/desktop-d1-cloud-shell-2026-08-25.md), and [D2 evidence](docs/verification/desktop-d2-local-generic-2026-08-25.md) |
